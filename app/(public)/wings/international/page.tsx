...
import { ArrowLeft, Globe, Languages, Handshake, Newspaper } from "lucide-react";
...
export default function InternationalWingPage() {
  ...
  const responsibilities = [
    { key: "wings.international.responsibilities.1", icon: Languages },
    { key: "wings.international.responsibilities.2", icon: Handshake },
    { key: "wings.international.responsibilities.3", icon: Newspaper },
    { key: "wings.international.responsibilities.4", icon: Globe },
  ];
