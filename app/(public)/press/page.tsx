...
const content = {
  ...
  aboutText: {
    en: "The Polish National-Integralist Movement (PRNI) is a political movement founded in 2024, dedicated to national sovereignty, tradition, and the integral unity of Poland. Motto: Nation above Everything.",
    pl: "Polski Ruch Narodowo-Integralistyczny (PRNI) to ruch polityczny założony w 2024 roku, działający na rzecz suwerenności, tradycji i integralności narodowej Polski. Motto: Naród Ponad Wszystkim.",
    de: "Die Polnische National-Integralistische Bewegung (PRNI) ist eine 2024 gegründete politische Bewegung für nationale Souveränität, Tradition und die integrale Einheit Polens. Motto: Nation über alles.",
  },
...
const keyFacts = [
  ...
  { label: { en: "Motto", pl: "Motto", de: "Motto" }, value: { en: "Nation above Everything", pl: "Naród Ponad Wszystkim", de: "Nation über alles" } },
