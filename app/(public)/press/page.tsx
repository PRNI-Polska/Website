...
const content = {
  ...
  aboutText: {
    en: "The Polish National-Integralist Movement (PRNI) is a political movement founded in 2024, dedicated to national sovereignty, tradition, and the integral unity of Poland. Motto: Nation Above All.",
...
const keyFacts = [
  ...
  { label: { en: "Motto", pl: "Motto", de: "Motto" }, value: { en: "Nation Above All", pl: "Naród Ponad Wszystkim", de: "Nation über alles" } },
